...
1. **饮食处方** (type: diet)
   - 高血压1级 → 限盐<6g/天，增加蔬菜水果摄入
   - 高血压2级 → 严格限盐<5g/天，DASH饮食模式
   - 高血压3级 → 严格低盐低脂饮食，控制液体摄入
   - 合并肥胖 → 控制总热量，减轻体重目标5-10%

2. **运动处方** (type: exercise)
   - 正常高值/1级 → 中等强度有氧运动，每周150分钟
   - 2级及以上 → 低至中等强度运动，避免屏气动作
   - 运动时监测血压，避免SBP>200mmHg的运动强度
...
4. **监测处方** (type: monitoring)
   - 正常高值 → 每月测血压，每年体检
   - 1级高血压 → 每周测血压2-3次，每3-6个月复查
   - 2级及以上 → 每日测血压，每1-3个月复查，心内科随访
   - 关注靶器官损害指标（心电图、肾功能、眼底）

5. **药物处方** (type: medication)
   - 高血压2级及以上 → 建议降压药物治疗
   - 合并糖尿病/CKD → 优先选择ACEI/ARB类
   - 合并冠心病 → β受体阻滞剂
